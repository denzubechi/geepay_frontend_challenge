        ...
        <header className="bg-background w-full py-2 lg:py-4  px-6 border-b border-gray-200 bg-gray-50 dark:bg-slate-950 dark:border-gray-700 absolute mx-auto z-50 ">
            <div className="flex items-center justify-between mx-auto w-full">
                ...
                <div className="hidden md:flex items-center space-x-4">
                    ...
                    <span className="text-sm dark:text-gray-300">November 15, 2023</span>
                    </div>
                    <div className='p-2'>
                    ...
                    <div className='cursor-pointer sm:flex md:flex items-center space-x-3 border border-gray-300 dark:gray-600 rounded-full p-2'>
                        ...
                        >
                        <Popover.Panel className="absolute top-10 -right-16 sm:right-4 z-50 mt-2 bg-white shadow-sm rounded-2xl max-w-xs sm:max-w-sm w-screen">
                        ...
                        <Menu as="div" className="relative inline-block text-left">
                            {({ open }) => (
                                ...
                                <Menu.Button className="cursor-pointer focus:outline-none flex items-center space-x-3 p-1  py-1 mx-4 border border-gray-400 dark:border-gray-500 rounded-full">
                                        ...
                                        <span className='dark:text-gray-300'>Chukwuma Samuel</span>
