...
const Navbar = () => {
    ...
    return (
        <header className="bg-background w-full py-4 px-6 border-b border-gray-200 bg-gray-50 dark:bg-black dark:border-gray-700 absolute mx-auto z-50 ">
            <div className="flex items-center justify-between mx-auto w-full">
                ...
                >
                    <Menu as="div" className="relative inline-block text-left">
                            {({ open }) => (
                                <>
                                    <Menu.Button className="cursor-pointer focus:outline-none flex items-center space-x-3 p-2 mx-2 border rounded-full">
                ...
                <div className="hidden md:flex items-center space-x-4">
                    ...
                    <div className='flex items-center space-x-3'>
                        <div className="relative">
                            ...
                            <input type="search" id="default-search" className="block w-full p-4  py-3 pl-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required />
                        </div>
                    </div>
                    <div className="flex items-center space-x-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <div >
                        <Menu as="div" className="relative inline-block text-left">
                            {({ open }) => (
                                <>
                                    <Menu.Button className="cursor-pointer focus:outline-none flex items-center space-x-3 p-2 border rounded-full">
                                        ...
                                        <div className="flex flex-col">
                                        <span>Chukwuma Samuel</span>
                                        <span className='text-gray-400'>
                                        Chukwumasam@gmail.com
                                        </span>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M3.19841 6.20675C3.43891 5.95614 3.81525 5.93336 4.08045 6.1384L4.15643 6.20675L10 12.2955L15.8436 6.20675C16.0841 5.95614 16.4604 5.93336 16.7256 6.1384L16.8016 6.20675C17.0421 6.45735 17.064 6.84951 16.8672 7.12585L16.8016 7.20502L10.479 13.7933C10.2385 14.0439 9.86217 14.0666 9.59697 13.8616L9.52099 13.7933L3.19841 7.20502C2.93386 6.92935 2.93386 6.48241 3.19841 6.20675Z" fill="#0D062D"className='fill-gray-700 dark:fill-gray-400'/>
