        ...
        <header className="bg-background w-full py-2 lg:py-4  px-6 border-b border-gray-200 bg-gray-50 dark:bg-black dark:border-gray-700 absolute mx-auto z-50 ">
            <div className="flex items-center justify-between mx-auto w-full">
                <span className='flex items-center gap-4'>
                    ...
                    <h1 className="text-md md:text-xl sm:text-xl font-semibold md:block">Dashboard</h1>
                ...
                >
                    <Menu as="div" className="relative inline-block text-left">
                            {({ open }) => (
                                <>
                                    <Menu.Button className="cursor-pointer focus:outline-none flex items-center space-x-3 p-2  mx-2 border border-gray-400 dark:border-gray-500 rounded-full">
            ...
            <Transition show={menuOpen}>
                ...
                >
                  ...
                  <div className="px-4 space-y-5">
                      ...
                      <div className=" cursor-pointer sm:flex md:flex items-center space-x-3 border border-gray-300 dark:gray-300 rounded-full p-2">
