...
const SideNav = () => {
    ...
    const sidebarClasses = `md:flex flex-col  justify-between pb-10 h-screen pt-24 lg:pt-28 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-black px-3 absolute top-0 left-0 ${
    ...
    return (
        <div className={` ${sidebarClasses}`}>
          ...
          <Link key={index} href={item.href}>
            <div className='flex items-center relative pl-3 py-1 hover:bg-green-200 rounded-lg'>
          ...
          <ThemeSwitch />
            ...
            <div className='flex flex-col gap-4 '>
                ...
                <div className='flex items-center relative pl-3'>
                    ...
                    <span className={linkTextClasses}>Log</span>
                </div>
                ...
                <path d="M12 4C13.05 4 14.05 4.17 14.97 4.49" stroke="#B2ABAB" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span className={linkTextClasses}>Sign Out</span>
                </div>
