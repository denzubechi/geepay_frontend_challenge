...
const SalesTrend = () => {
  return (
    <div className='bg-white text-gray-800 dark:bg-black dark:text-gray-200 p-4 m-2 ml-1 rounded-lg cards dark:border-0'>
        ...
        <p className="whitespace-nowrap text-sm lg:text-md font-light text-gray-500 sm:block">
            Sort by:
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-gray-700 dark:text-gray-300  font-medium  border rounded-full text-sm px-4 mx-2 py-2 text-center inline-flex items-center " type="button">Weekly<svg className="w-2 h-2 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
